...
🗑️ Deleted **${deletedRewards.deletedCount} rewards**`,
    ...
    @On()
    async inviteCreate([invite]: ArgsOf<'inviteCreate'>, client: SplayBot) {
        try {
    ...
    @On()
    async guildMemberAdd([member]: ArgsOf<'guildMemberAdd'>, client: SplayBot) {
        try {
