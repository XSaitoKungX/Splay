    ...
    if (!(guild.isPremium === 'true')) {
      if (!(await api.hasVoted(command.user.id)))
        return command.reply({
          content:
            'Please **[vote](https://top.gg/bot/851061262943256578/vote)** for me to access this command and then try again. \n\n **Premium servers can bypass this**\n You can get premium for just **$3.99** [here](https://www.patreon.com/xsaitokungx) \n Or \n **Boost** my support [server](http://88.99.90.219:28013/support)',

          components: new Components()
            .addButton('Upvote', 'Link', 'https://top.gg/bot/851061262943256578/vote')
