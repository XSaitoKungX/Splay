...
export class Owners {
  ...
  @On()
  async guildCreate([guild]: ArgsOf<'guildCreate'>, client: SplayBot) {
    ...
    if (guild.publicUpdatesChannel) {
      const newsChannel = bot.channels.cache.get('1140048887395135498') as unknown as NewsChannel;
...
**Docs:** https://splay.gitbook.io/splay
**Support:** https://discord.gg/j4YwfmEtbx
**Recommended Commands:** http://88.99.90.219:28013/recommended
**Patreon:** https://www.patreon.com/xsaitokungx`,
      });
...
**Patreon:** https://www.patreon.com/xsaitokungx`,
  ...
  @On()
  async guildDelete([guild]: ArgsOf<'guildDelete'>, client: SplayBot) {
