...
for (const config of configs) {
    ...
    manager.on('clusterCreate', (cluster) => {
        ...
        [${cluster.manager.shardsPerClusters}/${cluster.manager.totalShards} Shards]`.green,
        );
        ...
        cluster.on('death', function () {
          ...
          cluster.on('message', async (msg: any) => {
            if (msg.log) {
                ...
                fetch('http://88.99.90.219:28014/stats/logs/update', {
                    method: 'post',
            ...
            if (msg.ready) {
                async function submitstats() {
                    ...
                    await fetch('http://88.99.90.219:28015/stats/shards/update', {
                        method: 'post',
