...
import { SplayBot } from './types.js';

export default (client: SplayBot) => {
  /*
    _   _      _
  ...
  async function createInterface(ctx: Message | CommandInteraction, defaultContent: string, embedData: Embed) {
    if (!embedData.title && !embedData.description && !embedData.content)
      embedData = {
        ...
        description: `
                    <:KannaHello:867393926988824606> **User Variables**
                       __Variable <:bluearrow:1140239016776695818> Description <:bluearrow:1140239016776695818> Example__
                       \`{user:username}\` <:bluearrow:1140239016776695818> User's Name <:bluearrow:1140239016776695818> {user:username}
                       \`{user:discriminator}\` <:bluearrow:1140239016776695818> User's Discriminator<:bluearrow:1140239016776695818> {user:discriminator}
                       \`{user:tag}\` <:bluearrow:1140239016776695818> User's Tag<:bluearrow:1140239016776695818> {user:tag}
                       \`{user:mention}\` <:bluearrow:1140239016776695818> User ping<:bluearrow:1140239016776695818> {user:mention}
                       \`{user:invites}\` <:bluearrow:1140239016776695818> Number of users invited<:bluearrow:1140239016776695818> {user:invites}
                       \`{user:invites:left}\` <:bluearrow:1140239016776695818> Number of users left after inviting <:bluearrow:1140239016776695818> {user:invites:left}
                       \`{user:level}\` <:bluearrow:1140239016776695818> User's level<:bluearrow:1140239016776695818> {user:level}
                       \`{user:xp}\` <:bluearrow:1140239016776695818> User's xp <:bluearrow:1140239016776695818> {user:xp}
                       \`{user:rank}\` <:bluearrow:1140239016776695818> User's rank<:bluearrow:1140239016776695818> {user:rank}
                       \`{user:avatar}\` <:bluearrow:1140239016776695818> Link to user's avatar
                       <:invite:991410722204557432> **Inviter Variables** *The user who invited the user*
                       \`{inviter:username}\` <:bluearrow:1140239016776695818> User's Name <:bluearrow:1140239016776695818> {inviter:username}
                       \`{inviter:discriminator}\` <:bluearrow:1140239016776695818> User's Discriminator<:bluearrow:1140239016776695818> {inviter:discriminator}
                       \`{inviter:tag}\` <:bluearrow:1140239016776695818> User's Tag <:bluearrow:1140239016776695818> {inviter:tag}
                       \`{inviter:mention}\` <:bluearrow:1140239016776695818> User ping<:bluearrow:1140239016776695818> {inviter:mention}
                       \`{inviter:invites}\` <:bluearrow:1140239016776695818> Number of users invited<:bluearrow:1140239016776695818> {inviter:invites}
                       \`{inviter:invites:left}\` <:bluearrow:1140239016776695818> Number of users left after inviting <:bluearrow:1140239016776695818> {inviter:invites:left}
                       \`{inviter:level}\` <:bluearrow:1140239016776695818> User's level <:bluearrow:1140239016776695818> {inviter:level}
                       \`{inviter:xp}\` <:bluearrow:1140239016776695818> User's xp <:bluearrow:1140239016776695818> {inviter:xp}
                       \`{inviter:rank}\` <:bluearrow:1140239016776695818> User's rank<:bluearrow:1140239016776695818> {inviter:rank}
                       \`{inviter:avatar}\` <:bluearrow:1140239016776695818> Link to user's avatar
                     <:AH_LoveCat:1050681792060985414> **Server Variables**
                       \`{guild:name}\` <:bluearrow:1140239016776695818> Server's Name <:bluearrow:1140239016776695818> {guild:name}
                       \`{guild:owner}\` <:bluearrow:1140239016776695818> Ping to the server's owner <:bluearrow:1140239016776695818> {guild:owner}
                       \`{guild:members}\` <:bluearrow:1140239016776695818> Number of users in this server.
                       \`{guild:tier}\` <:bluearrow:1140239016776695818> Server's boosting tier <:bluearrow:1140239016776695818> {guild:tier}
                       \`{guild:description}\` <:bluearrow:1140239016776695818> Server's description <:bluearrow:1140239016776695818> {guild:description}
                       \`{guild:boosts}\` <:bluearrow:1140239016776695818>The number of boosts this server has <:bluearrow:1140239016776695818>3 {guild:boosts}
                       \`{guild:rules}\` <:bluearrow:1140239016776695818> The ping of the channel setup for rules <:bluearrow:1140239016776695818> {guild:rules}
  ...
  async function setTitle(message: Message, interaction: Interaction, embedData: Embed, config: Config) {
    message.edit({
      content:
        '**Send the title** \n <:info:1140239757889261668> To see a list of variables you can use `/embed variables` \n :x: To remove it send `cancel`',
      embeds: [],
      components: [],
    });
  ...
  async function setThumbnail(message: Message, interaction: Interaction, embedData: Embed, config: Config) {
    ...
    while (true) {
      message.edit({
        ...
        }**Send the url to set as the thumbnail.** \n\n <:info:1140239757889261668> This value must be a **link** or **{user:avatar}** or **{guild:icon}** or **{guild:banner}** or **{inviter:avatar}**\n :x: To remove it send \`cancel\``,
        embeds: [],
        components: [],
      });
  ...
  async function setColor(message: Message, interaction: Interaction, embedData: Embed, config: Config) {
    ...
    while (true) {
      message.edit({
        content: `${
          failed ? 'The message you sent was not a link.\n' : ''
        }**Send the hex value to set as the color for the embed.** \n\n <:info:1140239757889261668> This value must be a valid hexadecimal color. Example: #ffffff\n :x: To remove it send \`cancel\``,
        embeds: [],
        components: [],
      });
